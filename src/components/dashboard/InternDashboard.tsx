...
import { Building2, Calendar, MessageSquare, Award, BarChart3, LogOut, CheckSquare, Clock } from 'lucide-react';
...
const InternDashboard: React.FC<InternDashboardProps> = ({ profile: initialProfile }) => {
        ...
        <div className="flex items-center justify-between w-full">
          <div className="flex items-center space-x-2 lg:space-x-4">
            ...
            <div className="hidden sm:block">
              <h1 className="text-lg lg:text-xl font-bold text-gray-900">NTC Intern Hub</h1>
          ...
          <div className="flex items-center space-x-2 lg:space-x-4">
            ...
            <Dialog>
              <DialogTrigger asChild>
                <div className="h-8 w-8 lg:h-10 lg:w-10 rounded-full bg-gradient-to-r from-primary to-accent flex items-center justify-center text-white font-semibold text-xs lg:text-sm cursor-pointer hover:opacity-80 transition-opacity">
        ...
        <aside className="hidden lg:block w-72 bg-white/70 backdrop-blur-sm border-r border-primary/20 min-h-[calc(100vh-5rem)] shadow-sm">
          <div className="p-6">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} orientation="vertical" className="h-full">
              <TabsList className="grid w-full grid-rows-6 h-auto p-0 gap-2 bg-transparent">
                <TabsTrigger 
                  value="overview" 
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            ...
            <div className="lg:hidden mb-6">
              <TabsList className="grid grid-cols-4 w-full bg-white/70 p-1 rounded-xl">
                ...
                <TabsTrigger value="attendance" className="text-xs p-2">Attendance</TabsTrigger>
              </TabsList>
            </div>
            ...
            <TabsContent value="overview" className="space-y-6 lg:space-y-8 animate-fade-in">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <Button className="bg-gradient-to-r from-primary to-accent hover:from-primary/90 hover:to-accent/90 text-white shadow-lg w-full sm:w-auto">
                  Add New Task
                </Button>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
                <Card className="bg-gradient-to-br from-purple-500 to-purple-700 text-white border-0 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                  <CardContent className="p-6">
                    ...
                    <p className="text-purple-100 text-sm mb-4">Manage all your assignments</p>
                    <div className="text-sm text-purple-100 mb-2">{stats.assignedTasks} tasks • {stats.completedTasks > 0 ? Math.round((stats.completedTasks / stats.assignedTasks) * 100) : 0}%</div>
                    <div className="w-full bg-white/20 rounded-full h-2">
                      <div 
                        className="bg-white rounded-full h-2 transition-all duration-300" 
                        style={{ width: `${stats.assignedTasks > 0 ? (stats.completedTasks / stats.assignedTasks) * 100 : 0}%` }}
                      />
                    </div>
                  </CardContent>
                </Card>

                <Card className="bg-gradient-to-br from-cyan-400 to-cyan-600 text-white border-0 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center space-x-2">
                        <div className="flex -space-x-2">
                    ...
                    <p className="text-cyan-100 text-sm mb-4">Currently working on</p>
                    <div className="text-sm text-cyan-100 mb-2">{stats.inProgressTasks} tasks • 48%</div>
                    <div className="w-full bg-white/20 rounded-full h-2">
                      <div className="bg-white rounded-full h-2 w-12" />
                    </div>
                  </CardContent>
                </Card>

                <Card className="bg-gradient-to-br from-orange-400 to-orange-600 text-white border-0 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center space-x-2">
                        <div className="flex -space-x-2">
                    ...
                    <p className="text-orange-100 text-sm mb-4">Successfully finished</p>
                    <div className="text-sm text-orange-100 mb-2">{stats.completedTasks} tasks • 100%</div>
                    <div className="w-full bg-white/20 rounded-full h-2">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
                ...
                <div className="lg:col-span-2">
                  <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg">
                    <CardHeader>
                      <CardTitle className="text-gray-900 text-xl">Tasks for today</CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      <div className="flex items-center space-x-4 p-4 bg-orange-50 rounded-xl border-l-4 border-orange-400">
                      ...
                      <div className="flex items-center space-x-4 p-4 bg-purple-50 rounded-xl border-l-4 border-purple-400">
                        ...
                        <Button size="sm" variant="ghost" onClick={() => setActiveTab('calendar')}>
                          <Calendar className="h-4 w-4" />
                        </Button>
                      </div>

                      <div className="flex items-center space-x-4 p-4 bg-cyan-50 rounded-xl border-l-4 border-cyan-400">
                        <div className="w-3 h-3 bg-cyan-400 rounded-full" />
                        <div className="flex-1">
                          <h4 className="font-semibold text-gray-900">Attendance</h4>
                          <p className="text-sm text-gray-600">Mark your attendance</p>
                        </div>
                        <Button size="sm" variant="ghost" onClick={() => setActiveTab('attendance')}>
                  ...
                  <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg">
                    ...
                    <CardContent className="space-y-6">
                      <div className="text-center">
                        <div className="text-3xl font-bold text-gray-900">{stats.upcomingEvents} h</div>
                      ...
                      <div className="text-center">
                        <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-2xl p-6">
                          ...
                          <p className="text-xs text-blue-200">More productivity with premium!</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
            ...
            <TabsContent value="tasks" className="animate-fade-in">
              <TaskBoard userRole="intern" userId={profile.id} />
            </TabsContent>

            <TabsContent value="calendar" className="animate-fade-in">
              <EventCalendar userRole="intern" userId={profile.id} />
            </TabsContent>

            <TabsContent value="messages" className="animate-fade-in">
              <MessagingSystem userRole="intern" userId={profile.id} />
            </TabsContent>

            <TabsContent value="feedback" className="animate-fade-in">
              <FeedbackViewer userId={profile.id} />
            </TabsContent>

            <TabsContent value="certificates" className="animate-fade-in">
              <CertificateViewer userId={profile.id} />
            </TabsContent>

            <TabsContent value="attendance" className="animate-fade-in">
              <AttendanceSystem userRole="intern" />
            </TabsContent>
          </Tabs>
        </main>
      </div>
